 ...
 */
class Menu extends IntendantModel
{
    /**
     * @var array
     */
    ...
    public function __construct(array $attributes = [])
    {
        ...
        $this->setTable(config('intendant.'.$this->intendant_zone.'.database.menu_table'));
    }
    ...
    {
        $pivotTable = config('intendant.'.$this->intendant_zone.'.database.role_menu_table');
