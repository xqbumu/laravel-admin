...
use Encore\Admin\Providers\AdminServiceProvider;
...
class IntendantServiceProvider extends AdminServiceProvider
{
    ...
    public function __construct($app)
    {
        ...
        $this->moduleZone = Admin::getModuleZone() ?: 'admin';
    ...
    public function register()
    {
        $this->app->booting(function () {
            ...
            $loader->alias('Admin.'.$this->moduleZone, '\\Intendant\\'.ucfirst($this->moduleZone).'\\Providers\\Facades\\Admin');
