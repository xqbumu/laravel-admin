...
use Inchow\Incore\Docore as EnAdmin;
...
class Admin extends EnAdmin
{
     ...
     * @return string
     */
    const CONFIG_ZONE = '{$stub_intendant_zone}';
    ...
    {
        $directory = config('intendant.'.self::CONFIG_ZONE.'.directory');
    ...
    {
        $prefix = (string) config('intendant.'.self::CONFIG_ZONE.'.prefix');
    ...
    {
        return Auth::guard(config('intendant.'.self::CONFIG_ZONE.'.intendant.zone'))->user();
    }
    ...
    {
        return config('intendant.'.self::CONFIG_ZONE);
    }
    ...
    {
        return config('intendant.'.self::CONFIG_ZONE.'.intendant.zone');
    }
